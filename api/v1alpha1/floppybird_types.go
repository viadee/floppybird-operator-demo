...
type Floppybird struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec   FloppybirdSpec   `json:"spec,omitempty"`
	Status FloppybirdStatus `json:"status,omitempty"`
}

//+kubebuilder:object:root=true

// FloppybirdList contains a list of Floppybird
type FloppybirdList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []Floppybird `json:"items"`
}

func init() {
	SchemeBuilder.Register(&Floppybird{}, &FloppybirdList{})
}
